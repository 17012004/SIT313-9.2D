...
function FindQuestion() {
  ...
  const handleFilter = () => {
    const filteredQuestions = questions.filter((question) => {
      const titleMatch = question.title.toLowerCase().includes(filterTitle.toLowerCase());
      const tagMatch = question.tag.toLowerCase().includes(filterTag.toLowerCase());
      const dateMatch = filterDate === "" || (question.date && question.date === filterDate);
